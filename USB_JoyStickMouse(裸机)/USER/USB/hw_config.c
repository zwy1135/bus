...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define JOY_UP       GPIO_Pin_6  /* PD.11 */
#define JOY_DOWN     GPIO_Pin_7  /* PD.12 */
#define JOY_LEFT     GPIO_Pin_9  /* PD.13 */
#define JOY_RIGHT    GPIO_Pin_8  /* PD.14 */
#define JOY_LEFT_BUTTON    GPIO_Pin_0  /* PA.0 */
#define JOY_RIGHT_BUTTON    GPIO_Pin_2  /* PB.2 */
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
...
uint8_t JoyState(void)
{
  ...
  if (GPIO_ReadInputDataBit(GPIOA, JOY_LEFT_BUTTON))
  {
   ...
   if ( GPIO_ReadInputDataBit(GPIOB, JOY_RIGHT_BUTTON))
  {
    return RIGHT_BUTTON;
  }
  /* No key is pressed */
